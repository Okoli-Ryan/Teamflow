...
const features = [
	{
		...
		HoverElement: () => (
			<div className="px-4 py-2 shadow-md absolute bottom-[20%] right-[20%] bg-white bounce-far">
				<img src={FeatureHover1} className="w-auto h-8 " />
			</div>
		),
	...
	},
	{
		...
		HoverElement: () => (
			<>
				<img src={Feature2Hover1} className="w-auto h-12 bounce-far absolute left-[20%] top-2" />
				<img src={Feature2Hover2} className="w-auto h-16 bounce-far bounce-delay absolute right-0 top-[10%]" />
			</>
		),
